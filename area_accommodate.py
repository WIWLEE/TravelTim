...
def get_kth_area_accommodate_page(k, keyword, typeId) :
    ...
    if dic['response']['body']['totalCount'] == '1' :
        ...
        main_title = "List of {} accommodate".format(keyword)
    ...
    if 'accommodate' in content or 'accommodation' in content :
        for idx, keyword in enumerate(keyword_list):
            ...
            if keyword in content and (u"more" in content or u"other" in content):
                data_send = get_kth_area_accommodate_page(1, keyword, 80)
                return data_send
